...
class ProductsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            'photo' => 'https://www.dhresource.com/0x0/f2/albu/g9/M01/D8/23/rBVaVV790GCANW_JAAMgwaulMiE847.jpg/original-unlocked-5-8-inch-iphone-x-in-iphone.jpg',
            'price' => 983.00
        ]);
        DB::table('products')->insert([
...
• No returns, but backed by eBay Money back guarantee',
        ...
        DB::table('products')->insert([
            ...
            'photo' => 'https://i2.wp.com/www.ngtechgist.com/wp-content/uploads/2018/05/Huawei-elate-4g.jpg?resize=400%2C403&ssl=1',
            'price' => 68.00
        ]);
        DB::table('products')->insert([
            'name' => 'HTC One M10',
